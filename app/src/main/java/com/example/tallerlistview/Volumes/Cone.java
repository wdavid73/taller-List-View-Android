...
public class Cone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculate_volume_cone);
    ...
    public void calculate(View v){
        ...
        if(validate()){
            ...
            res = (Math.PI * Math.pow(value_radius,2)*value_high)/3;
            BigDecimal area = new BigDecimal(res);
            area = area.setScale(2, RoundingMode.DOWN);
            result.setText(getString(R.string.volume_cone)+" : "+area);

            operation = new Operation(
                    ""+getString(R.string.volume_cone_result),
